...
import minigrid
from minigrid.wrappers import FlatObsWrapper  # <-- 1. Import the correct wrapper
...
MODEL_FILENAME = "ppo_doorkey_5x5_mlp.zip"
LOGS_DIR = "logs/"
...
def train_agent():
    ...
    # 2. Use the MiniGrid-specific FlatObsWrapper
...
def visualize_agent():
    ...
    # 3. CRITICAL: Use the SAME wrapper for visualization
...
def evaluate_agent():
    ...
    # 3. CRITICAL: Use the SAME wrapper for evaluation
